...
# ───────────────────── Константы ────────────────────────────────
WB_TOKEN  = "eyJhbGciOiJFUzI1NiIsImtpZCI6IjIwMjQxMjE3djEiLCJ0eXAiOiJKV1QifQ.eyJlbnQiOjEsImV4cCI6MTc1MTkzOTcwNSwiaWQiOiIwMTk0M2JlNS1kNDIzLTc0OGQtOGM4NC01ZmMyMjA3ZDY1YzUiLCJpYWQiOjcxOTUyMDQzLCJvaWQiOjI3NjkwNywicyI6NzkzNCwic2lkIjoiZDMyZjgyMjQtNjY4Mi00ZmI2LWJkNWUtMDU3ZjA3NmE5NjllIiwidCI6ZmFsc2UsInVpZCI6NzE5NTIwNDN9.9piJOR1Z9w9kRx5KSZKJ5aN1yG4clHaCUF9oujD5buYQIZf_5c9tB6G7rb5UOL-ZoQGIAIWYFUM9rhhAmG-enA"                        # <= вставьте свой
...
# Папка для всех сохраняемых логов и промежуточных данных
...
def dump_filtered(cards, vcodes:set):
    ...
    fname = str(LOG_DIR / f"wb_cards_{datetime.now():%Y-%m-%d}.json")
...
if __name__ == "__main__":
    vcodes = load_vendor_codes("articuls.xlsx")
    wb_all = wb_get_all()
    wb_need = dump_filtered(wb_all, vcodes)
    if not wb_need:
        print("⛔ Ничего не найдено по этим vendorCode") ; sys.exit()

    # ——— делим на батчи ≤100 и шлём в Ozon ———
